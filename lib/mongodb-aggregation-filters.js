...
const MongoDBFunctionAsFilter = require('./helpers/functions-types/function-as-filter');
...
class MongoDBAggregationFilters extends MongoDBFilters {
	...
	static _parseWithFunctionClass(filterName, filterData, functionClass) {
		...
		const isValidFunctionClass = functionClass.prototype instanceof MongoDBFunctionAsFilter;
