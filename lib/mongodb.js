...
const { MongoWrapper, ObjectId } = require('./mongodb-wrapper');
...
module.exports = class MongoDB {
	 ...
	 * @returns {Promise<boolean|object>} true/false or detailed result if rawResponse is true
	*/
			...
			if(rawResponse) {
				...
				return {
					...
					operations: operations.map((operation, index) => {
						...
						const operationErrors = writeErrors.filter(error => error.index === index);
